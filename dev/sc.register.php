...
mysql_query("insert into devs (user,pass,email) values ('".mysql_real_escape_string($u)."','".sha1($p."strawberries")."','".mysql_real_escape_string($e)."')") or die("Failed to add user");
$did=mysql_insert_id();
$expiry=time()+(3600*24);
